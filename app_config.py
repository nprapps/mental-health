...
PROJECT_SLUG = 'mental-health'

# Project name to be used in file paths
PROJECT_FILENAME = 'mental_health'

# The name of the repository containing the source
REPOSITORY_NAME = 'mental-health'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1P1mpcLxnEyFVpnkOByFY3g5Yus-iQvCPeYQ8Xq6rqXc'
...
NPR_GOOGLE_ANALYTICS = {
    ...
    'TOPICS': 'p1013, 1001, 1066, 1133, 1135' # e.g. '[1014,3,1003,1002,1001]'
}
